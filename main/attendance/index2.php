...
switch ($action) {
    ...
    case 'attendance_sheet_list':
        ...
        break;
    case 'all_attendance_sheet_list':
        ...
        */
        /* Obtenemos los cursos con la siguiente estructura */
        /*
        array (
          'in_category' =>
          array (
          ...
          array (
            ...
            array (
              ...
              'visibility' => '2',
              'link' => 'http://chamilo.local.com/courses/3268/index.php?id_session=0',
              'thumbnails' => NULL,
              'image' => 'http://chamilo.local.com/main/img/session_default.png',
              'title' => '3268',
              'title_cut' => '3268',
              'category' => NULL,
              'category_code' => NULL,
              ...
              array (
                ...
                array (
                  ...
                  'lastname' => 'Pérez',
                  'firstname' => 'Juan',
                  'email' => 'alvaradocarlo@gmail.com',
                  'username' => 'admin',
                  'status' => '1',
                  'fullname' => 'Pérez, Juan',
                  'avatar' => 'http://chamilo.local.com/main/img/icons/32/unknown.png',
                  'url' => 'http://chamilo.local.com/main/inc/ajax/user_manager.ajax.php?a=get_user_popup&course_id=13&user_id=1',
                ),
              ),
              'extrafields' =>
              array (
              ...
              array (
                ...
                array (
                  ...
                  array (
                    0 =>
                    array (
                      'date_time' => '05 de Julio 2020 a las 10:20 PM',
                      0 => '2020-07-05 22:20:00',
                      'presence' => '1',
                      1 => '1',
                      'datetime' =>
                      DateTime::__set_state(array(
                         'date' => '2020-07-05 22:20:00.000000',
                         'timezone_type' => 3,
        ...
        */
        // $courses = $attendance->getCoursesWithAttendance($student_id,$startDate,$endDate);
/*
        $controller = new IndexManager(get_lang('MyCourses'));
        //$courses = $this->getCoursesWithAttendanceByStudentId($student_id, $dateStart, $dateEnd);
        $courses = $controller->returnCoursesAndSessions(
            $student_id,
            true,
            null,
            true,
            false);
        */
        $attendanceController->allAttendanceList();
        exit();
